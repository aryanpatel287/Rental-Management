...
import { sanitizeIdentifier } from './table-manager.service.js';
...
export async function findById(slug, id) {
    ...
    try {
        ...
        console.error(`Error querying record by ID in "${tableName}":`, error);
...
export async function softDelete(slug, id) {
    ...
    try {
        ...
        console.error(`Error soft deleting record in "${tableName}":`, error);
